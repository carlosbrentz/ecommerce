        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <img src="<?php echo getUserPhoto(); ?>" class="user-image" alt="User Image">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                <img src="<?php echo getUserPhoto(); ?>" class="img-circle" alt="User Image">

                <p>
                  <?php echo getUserName(); ?>
                  <small>Membro desde <?php echo getUserMemberSince(); ?></small>
                </p>
              </li>
              <!-- Menu Body -->
              <li class="user-body">
