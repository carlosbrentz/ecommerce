<?php if(!class_exists('Rain\Tpl')){exit;}?><form method="post" action="https://pagseguro.uol.com.br/v2/checkout/payment.html">  
        ...
        <!-- Campos obrigatórios -->  
        <input name="receiverEmail" type="hidden" value="cazeca@zipmail.com.br">  
        ...
        <input name="shippingAddressComplement" type="hidden" value="<?php echo utf8_encode($order["desnumber"]); ?>">  
